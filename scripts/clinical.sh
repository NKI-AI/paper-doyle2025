...
EXPERIMENT_NAME="Clinical_only_outersplit${OUTER_SPLIT}COXPH_months_acc_noNAs_withouther2border${DS_NAME}_${CLINICAL_VARS}_years${YRS}_final"
...
SLOANE_PARAMS="data=Sloane/default.yaml experiment.train=false  data.data_sel_params.cutoff_years=$YRS"
python ../../drop/engine/cls/trainer_ml.py $RUN_CONFIG $MLFLOW_PARAMETERS  $HYPERPARAMETERS $SLOANE_PARAMS
